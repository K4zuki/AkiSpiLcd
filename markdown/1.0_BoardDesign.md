...
RAMが少ないマイコン視点では画素メモリを読み出せる方が便利ですが、昨今のSoCは
十分なRAMを搭載しているのでVRAMを自前で用意することになっても困らないので削られたのでしょう。
それに消費電力にも影響すると思われます。
...
- [5-4] Maximum wet-bulb temperature should be 57 or lower. Do not allow condensation.
