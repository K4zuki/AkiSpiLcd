...
```bitfield
input: data/bitfields/commandbits.yaml
caption: コマンドビット
---
```
...
```bitfield
input: data/bitfields/generalpurpose.yaml
caption: 汎用ビット
---
```
...
```bitfield
input: data/bitfield16/sharpcls.yaml
bits: 16
caption: メモリ全消し
---
```
...
```bitfield
input: data/bitfield16/sharptransfer.yaml
bits: 16
caption: 画素データ更新（1ライン）
---
```
...
```bitfield
input: data/bitfield16/sharpnop.yaml
bits: 16
caption: COM反転
---
```
